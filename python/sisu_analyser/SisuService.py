...
class SisuService:
    def carregarCursos(self, caminho_arquivo: str):
        ...
        try:
            # Se o caminho for relativo, tenta encontrar na pasta resources
            if not os.path.isabs(caminho_arquivo):
                # Tenta encontrar o arquivo na pasta resources
                resources_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'resources', caminho_arquivo)
